...
public class Exercise extends ExerciseBase {
    ...
    /*
        ...
        -1, 1  | [-1,0,1]
     */
    public int[] constructNumberArray(int startInteger, int endInteger) {
        int[] array = IntStream.rangeClosed(startInteger, endInteger).toArray();
        return array;
    }
    ...
    /*
        ...
        error, 10   | ERROR!!!!!!!!!!
     */
    public String shout(String message, int urgency) {
        return message.toUpperCase().concat("!".repeat(urgency));
    }
